...
public class Navi extends BodyTagSupport{
	public static final String CONFIG_FLAG_KEY = "_anyboot_navi_conf_";
	...
	private String style = "default"; 	//样式标记对应anyboot-navi.xml中的config.key
	...
	public int doStartTag() throws JspException {
		try{
			...
			int idx = BasicUtil.parseInt((String)pageContext.getRequest().getAttribute("_anyboot_navi_tag_idx"), 0);
			String flag = id;
			if(null == flag){
				flag = idx+"";
			}
			...
			builder.append("</div>");
			idx ++;
			pageContext.getRequest().setAttribute("_anyboot_navi_tag_idx", idx + "");
