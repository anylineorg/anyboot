...
package org.anyboot.service.impl;
...
import org.anyboot.cache.CacheUtil;
import org.anyboot.cache.PageLazyStore;
...
import org.anyboot.config.db.SQL.ORDER_TYPE;
import org.anyboot.config.db.ds.DataSourceHolder;
import org.anyboot.config.db.impl.PageNaviImpl;
import org.anyboot.config.db.impl.ProcedureImpl;
import org.anyboot.config.db.impl.SQLStoreImpl;
import org.anyboot.config.db.sql.auto.impl.TableSQLImpl;
import org.anyboot.config.db.sql.auto.impl.TextSQLImpl;
import org.anyboot.config.http.ConfigStore;
import org.anyboot.config.http.impl.ConfigStoreImpl;
...
import org.anyboot.exception.SQLQueryException;
import org.anyboot.service.AnybootService;
...
@Service("anybootService")
public class AnybootServiceImpl implements AnybootService {
	protected final Logger log = Logger.getLogger(this.getClass());
	@Autowired(required = false)
	@Qualifier("anybootDao")
	protected AnybootDao dao;
	
	
	public AnybootDao getDao() {
		return dao;
	}
	...
	private DataSet queryFromCacheL1(boolean isUseCacheL2, String cache, String src, ConfigStore configs, String ... conditions){
		...
		DataSet set = null;
		String key = "SET:";
		String cache2 = "anyboot_cache_l2";
