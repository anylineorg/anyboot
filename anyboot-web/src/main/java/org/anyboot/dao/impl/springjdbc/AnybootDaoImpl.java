...
package org.anyboot.dao.impl.springjdbc;
...
import org.anyboot.config.ConfigParser;
...
import org.anyboot.dao.impl.BatchInsertStore;
...
@Repository("anybootDao")
public class AnybootDaoImpl implements AnybootDao {
	private static final Logger log = Logger.getLogger(AnybootDaoImpl.class);
