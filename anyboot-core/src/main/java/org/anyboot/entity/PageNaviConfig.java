...
public class PageNaviConfig extends BasicConfig{
	...
	//key
	public String KEY_PAGE_ROWS			= "_anyboot_page_rows"			; //设置每页显示多少条的key			
	public String KEY_PAGE_NO			= "_anyboot_page"				; //设置当前第几页的key
	public String KEY_TOTAL_PAGE		= "_anyboot_total_page"			; //显示一共多少页的key
	public String KEY_TOTAL_ROW			= "_anyboot_total_row"			; //显示一共多少条的key
	public String KEY_SHOW_STAT			= "_anyboot_navi_show_stat"		; //设置是否显示统计数据的key
	public String KEY_SHOW_JUMP			= "_anyboot_navi_show_jump"		; //设置是否显示页数跳转key
	public String KEY_GUIDE				= "_anyboot_navi_guide"			; //设置分页样式的key
	...
	private synchronized static void loadConfig() {
		loadConfig(instances, PageNaviConfig.class, "anyboot-navi.xml", compatibles);
