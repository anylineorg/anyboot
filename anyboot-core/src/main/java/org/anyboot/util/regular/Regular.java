...
public interface Regular {
	...
	public static enum PATTERN{
		...
		* 匹配 : http://www.anyboot.org 或news://www
		* 提取(MatchResult matchResult=matcher.getMatch()):   
		*              matchResult.group(0)= http://www.anyboot.org:8080/index.html?login=true   
		*              matchResult.group(1) = http   
		*              matchResult.group(2) = www.anyboot.org   
		...
		* 匹配 : http://www.anyboot.org:8080/index.html?login=true
		* 提取(MatchResult matchResult=matcher.getMatch()):   
		*              matchResult.group(0)= http://www.anyboot.org:8080/index.html?login=true   
		*              matchResult.group(1) = http   
		*              matchResult.group(2) = www.anyboot.org   
