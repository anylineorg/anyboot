...
public class TemplateView extends JstlView {
	...
	public static final String ANYBOOT_TEMPLATE_NAME				= "template_name";
	public static final String ANYBOOT_STYLE_TEMPLATE_DES			= "style_template_des";
	public static final String ANYBOOT_TEMPLATE_NAME_DEFAULT		= "default";
	public static final String ANYBOOT_TEMPLATE_CONTENT_PATH 		= "anyboot_template_content_path";
	...
	public void render(Map model, HttpServletRequest request,
		...
		if(null != model){
			...
			template = (String)model.get(ANYBOOT_TEMPLATE_NAME);
		}
		if(null == template){
		...
		if(null != template){
			...
			request.setAttribute(ANYBOOT_TEMPLATE_CONTENT_PATH, content_url);
