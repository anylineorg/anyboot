...
public class TemplateModelAndView extends ModelAndView{
	public static final String DATA_URL 		= "anyboot_template_data_url";			//加载数据URL 
	public static final String STYLE_URL	 	= "anyboot_template_style_url"; 	//加载数据模板文件URL
	public static final String DATA_PARSER 		= "anyboot_template_data_parser";  		//模板文件解析配置
	public static final String CONTENT_URL 		= "anyboot_template_content_url"; 		//内容页面加载URL
	public static final String PAGE_TITLE		= "anyboot_template_page_title";						//页面标题
	...
	public TemplateModelAndView setStyle(String template){
		...
		try{
			...
			addObject(TemplateView.ANYBOOT_STYLE_TEMPLATE_DES, WebUtil.encrypt(data_template));
		}catch(Exception e){
			e.printStackTrace();
		}
		return this;
